...
def get_price_history(
    ...
    VARIANT_ALIASES = {
        ...
        "normal": ["normal", "holofoil", "holo", "1stEditionHolofoil", "1stEditionNormal", "unlimitedHolofoil", "unlimited"],  # Vintage cards may have different edition variants on TCGPlayer
    }
